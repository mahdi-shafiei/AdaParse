# --------------------------------------------------------
# Legacy Swin Transformer - from timm 0.5.4 - Self-Contained
# Implementation based on: `Swin Transformer: Hierarchical Vision Transformer using Shifted Windows`
#    - https://arxiv.org/pdf/2103.14030
# subsequent timm versions broke `self.model.pos_drop`
# stripped of external dependencies for exact numerical compatibility
...
from .layers.vision_transformer import _init_vit_weights

# ============================================================================
# UTILITY CLASSES (./models/layers/mlp.py, models/layers/drop.py)
# ============================================================================
...
# CORE SWIN TRANSFORMER IMPLEMENTATION
#  exact timm 0.5.4 version
